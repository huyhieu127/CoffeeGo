...
fun OrderDetailScreen(
    ...
    val coffeeId = orderDetailDest.coffeeId
    val order = orderDetailDest.getOrder()
    LaunchedEffect(order?.id, coffeeId) {
        viewModel.loadData(order, coffeeId)
    }
    OrderDetailUi(
